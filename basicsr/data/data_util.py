...
def paired_paths_from_folder(folders, keys, filename_tmpl, task):
    ...
    input_folder, ref_folder, gt_folder = folders
    input_key, ref_key, gt_key = keys
    ...
    paths = []
    for gt_path, ref_path in zip(gt_paths, ref_paths):
        ...
        # print(input_path, ref_path, gt_path)
        paths.append(dict([(f'{input_key}_path', input_path), (f'{ref_key}_path', ref_path), (f'{gt_key}_path', gt_path)]))
    return paths
